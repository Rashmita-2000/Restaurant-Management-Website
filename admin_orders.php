...
$sql = "select u.id as userid ,u.username,o.id as orderid,o.purchase_amount,o.order_date FROM 
...
<img src=Capture.PNG alt="Paris">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
      ...
      <h1>TRACK ORDERS</h1>
	<form  method="POST" action="trackorder.php" onsubmit>
		<div class="form-group">
		<label>
			ORDER ID <input type="text" id="oid" name="oid" onsubmit="myFunction(this.value);" required>
		</label>
		<label>
			CUSTOMER ID <input type="text" id="uid" name="uid" required>
		</label>

		<input type="submit" id="desc" name="orderbtn" value="submit">
	</div>
	</form>
	<section> 
		<h1>ORDER DETAILS</h1> 
